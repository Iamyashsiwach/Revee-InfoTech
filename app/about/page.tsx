...
export const metadata: Metadata = {
  title: "About Us | Revee InfoTech",
  description: "Learn about Revee InfoTech's mission, values, and team of network integration experts",
};
  ...
  const teamMembers = [
    {
      name: "John Smith",
      title: "CEO & Founder",
      bio: "With over 20 years of experience in network engineering, John founded Revee InfoTech to deliver enterprise-grade solutions to businesses of all sizes.",
