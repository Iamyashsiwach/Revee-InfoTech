            ...
            <div>
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm md:text-base text-gray-700 mb-1">support@reveeinfotech.com</p>
                  </div>
                </div>
              ...
              <div className="mt-8 md:mt-10">
                ...
                <div className="flex space-x-3 md:space-x-4">
                  <a href="https://www.linkedin.com/company/revee-infotech-private-limited" target="_blank" rel="noopener noreferrer" className="p-2 bg-blue-500 text-white hover:bg-blue-600 rounded-full transition-colors">
                  ...
                  <a href="https://www.instagram.com/reveeinfotech/" target="_blank" rel="noopener noreferrer" className="p-2 bg-pink-500 text-white hover:bg-pink-600 rounded-full transition-colors">
                    <svg className="h-5 w-5 md:h-6 md:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
