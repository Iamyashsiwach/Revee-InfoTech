    ...
    <footer className="bg-gray-900 text-white py-8 md:py-12">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-lg md:text-xl font-poppins font-semibold mb-3 md:mb-4 text-teal-400">Revee InfoTech</h3>
            ...
            <div className="flex space-x-4">
              {/* LinkedIn icon */}
              <a href="https://www.linkedin.com/company/revee-infotech-private-limited" target="_blank" rel="noopener noreferrer" className="text-gray-200 hover:text-teal-400 p-1">
              ...
              {/* Instagram icon */}
              <a href="https://www.instagram.com/reveeinfotech/" target="_blank" rel="noopener noreferrer" className="text-gray-200 hover:text-teal-400 p-1">
                <svg className="h-5 w-5 md:h-6 md:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm md:text-base text-gray-200">
              ...
              <li className="flex items-start">
                ...
                <span>Office Address: Unit No 511, 5th Floor Emerald Plaza Sector 65 Gurgaon 122102</span>
              </li>
              {/* Phone with icon */}
              <li className="flex items-start">
                <svg className="h-5 w-5 md:h-6 md:w-6 mr-2 text-teal flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start">
                ...
                <a href="mailto:support@reveeinfotech.com" className="text-gray-200 hover:text-teal-400">Email ID: support@reveeinfotech.com</a>
              </li>
            </ul>
          </div>
        </div>
