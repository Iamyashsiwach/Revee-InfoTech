...
export async function generateMetadata({ 
  ...
  if (!caseStudy) {
    return {
      title: "Case Study Not Found | Revee InfoTech",
  ...
  const caseStudies = [
    {
      ...
      testimonial: {
        quote: "Revee InfoTech transformed our global infrastructure, providing us with a secure, high-performance network that has significantly improved our operational efficiency. Their methodical approach to the implementation ensured minimal disruption to our manufacturing processes.",
        name: "Robert Chen",
        title: "CIO",
    ...
    },
    {
      ...
      testimonial: {
        quote: "Revee InfoTech's expertise in both cloud technologies and financial compliance was exactly what we needed. They developed and executed a migration strategy that has given us the benefits of cloud computing without compromising security or regulatory compliance.",
        name: "Sarah Johnson",
        title: "CISO",
    ...
    },
    {
      ...
      testimonial: {
        quote: "The cybersecurity solution implemented by Revee InfoTech has transformed our security posture. Their healthcare-specific expertise ensured that we not only protected our patient data but did so in a way that maintained operational efficiency for our clinical staff.",
