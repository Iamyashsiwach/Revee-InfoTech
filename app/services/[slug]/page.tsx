...
export const generateMetadata = ({ params }: { params: any }): Metadata => {
  ...
  if (!service) {
    return {
      title: "Service Not Found | Revee InfoTech",
      description: "The requested service could not be found.",
    };
  }
  
  return {
    title: `${service.title} | Revee InfoTech Services`,
          ...
          <div className="max-w-3xl">
            <div>
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <Button asChild variant="outline" size="lg" className="bg-transparent text-white border-white hover:bg-white hover:text-navy font-semibold px-6">
